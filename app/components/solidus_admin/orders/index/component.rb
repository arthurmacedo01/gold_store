  ...
  def state_column
    {
      ...
      data: ->(order) do
        ...
        component("ui/badge").new(name: t("spree.order_state.#{order.state}"), color:)
      end
    }
  end
  ...
  def payment_column
    {
      header: :payment,
      data: ->(order) do
        component("ui/badge").new(name: t("spree.payment_states.#{order.payment_state}"), color: order.paid? ? :green : :yellow) if order.payment_state?
      end
    }
  end
  ...
  def shipment_column
    {
      header: :shipment,
      data: ->(order) do
        component("ui/badge").new(name: t("spree.shipment_states.#{order.shipment_state}"), color: order.shipped? ? :green : :yellow) if order.shipment_state?
      end
    }
  end
end
