  ...
  module Core
    ...
    module ProductFilters
      ...
      def self.price_filter(store_id = nil)
        ...
        conds = [[I18n.t('spree.under_price', price: format_price(max_price/1000*50)), value[:amount].lteq(max_price/1000*50)],
                 ["#{format_price(max_price/1000*50)} - #{format_price(max_price/1000*100)}", value[:amount].between(max_price/1000*50..max_price/1000*100)],
                 ["#{format_price(max_price/1000*100)} - #{format_price(max_price/1000*200)}", value[:amount].between(max_price/1000*100..max_price/1000*200)],
                 ["#{format_price(max_price/1000*200)} - #{format_price(max_price/1000*500)}", value[:amount].between(max_price/1000*200..max_price/1000*500)],
                 [I18n.t('spree.or_over_price', price: format_price(max_price/1000*500)), value[:amount].gteq(max_price/1000*500)]]
        {
